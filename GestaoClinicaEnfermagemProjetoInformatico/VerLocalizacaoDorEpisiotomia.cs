    ...
    public partial class VerLocalizacaoDorEpisiotomia : Form
    {
        ...
        private void ver()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from LocalizacaoDorEpisiotomia WHERE IdPaciente = @IdPaciente ORDER BY data", conn);
