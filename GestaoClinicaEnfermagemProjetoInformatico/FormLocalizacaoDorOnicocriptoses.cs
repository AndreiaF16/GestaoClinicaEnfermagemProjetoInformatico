...
{
    public partial class FormLocalizacaoDorOnicocriptoses : Form
    {
        Paciente paciente = null;
        public FormLocalizacaoDorOnicocriptoses(Paciente ut)
        {
            InitializeComponent();
            paciente = ut;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryInsertData = "INSERT INTO LocalizacaoDorOnicocriptoses(idPaciente,localizacao) VALUES(@idPaciente,@localizacao);";
