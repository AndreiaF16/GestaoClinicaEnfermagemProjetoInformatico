        ...
        private void UpdateDataGridView()
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        nome = ((reader["designacao"] == DBNull.Value) ? "" : (string)reader["designacao"]),
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Por erro interno é impossível selecionar o tipo de despesa!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
