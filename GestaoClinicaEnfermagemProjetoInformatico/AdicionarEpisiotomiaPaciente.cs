...
{
    public partial class AdicionarEpisiotomiaPaciente : Form
    {
        SqlConnection conn = new SqlConnection();
        SqlCommand com = new SqlCommand();
        private Paciente paciente = new Paciente();
        private ErrorProvider errorProvider = new ErrorProvider();
        private List<Episiotomia> episiotomia = new List<Episiotomia>();
        private Enfermeiro enfermeiro = null;
        public AdicionarEpisiotomiaPaciente(Paciente pac)
        {
            InitializeComponent();
            paciente = pac;
            ...
            dataEpisiotomia.Value = DateTime.Today;
        }
        ...
        {
            VerEpisiotomiaRegistada verVacinacaoRegistada = new VerEpisiotomiaRegistada(paciente);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (VerificarDadosInseridos())
                {
                    ...
                    string queryInsertData = "INSERT INTO Episiotomia(IdPaciente,data,fev,fvc,fr,caracteristicaSuperficial,caracteristicaProfunda,caracteristicaAdbominal,caracteristicaToracica,caracteristicaMista,escalaDor,observacoes)" +
                    ...
                    MessageBox.Show("Episiotomia registada com Sucesso!", "Sucesso!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    connection.Close();
                    UpdateDataGridView();
                    limparCampos();
                }
        ...
        public void UpdateDataGridView()
        {
            try
            {
                ...
                var bindingSource1 = new System.Windows.Forms.BindingSource { DataSource = episiotomia };
                conn.Close();
        ...
        {
            DateTime data = dataEpisiotomia.Value;
            ...
            if (var > 0)
            {
                ...
                errorProvider.SetError(dataEpisiotomia, "A data tem de ser inferior ou igual à data de hoje!");
                return false;
            }
        ...
        {
            FormLocalizacaoDorEpisiotomia formLocalizacaoDorCorpo = new FormLocalizacaoDorEpisiotomia(paciente);
