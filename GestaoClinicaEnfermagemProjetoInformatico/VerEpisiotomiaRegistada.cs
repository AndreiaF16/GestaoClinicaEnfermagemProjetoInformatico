...
{
    public partial class VerEpisiotomiaRegistada : Form
    {
        ...
        public VerEpisiotomiaRegistada(Paciente pac)
        {
            InitializeComponent();
            paciente = pac;
        ...
        {
            var bindingSource2 = new System.Windows.Forms.BindingSource { DataSource = episiotomia };
