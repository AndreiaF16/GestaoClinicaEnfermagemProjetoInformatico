    ...
    public partial class AdicionarTricotomiaPaciente : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            catch (SqlException)
            {
                ...
                MessageBox.Show("Por erro interno é impossível registar a tricotomia!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private Boolean VerificarDadosInseridos()
        {
            ...
            if (var > 0)
            {
                MessageBox.Show("A data da tricotomia tem de ser inferior ou igual à data de hoje! \n Selecione outra data!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        MessageBox.Show("Não é possível registar a tricotomia, porque já está um registo na data que selecionou! \n Selecione outra data!", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        conn.Close();
                        return false;
                    }
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Por erro interno é impossível selecionar as tricotomias do paciente!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            VerTricotomia verTricotomia = new VerTricotomia(paciente);
            verTricotomia.Show();
        }
    }
}
