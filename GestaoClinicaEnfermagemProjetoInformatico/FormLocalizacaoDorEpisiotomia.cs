...
{
    public partial class FormLocalizacaoDorEpisiotomia : Form
    {
        ...
        public FormLocalizacaoDorEpisiotomia(Paciente pac)
        {
            InitializeComponent();
            paciente = pac;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (VerificarDadosInseridos())
            {
                ...
                try
                {
                    ...
                    string queryInsertData = "INSERT INTO LocalizacaoDorEpisiotomia(idPaciente,data,localizacao,observacoes) VALUES(@idPaciente,@dataR,@localizacao,@obs);";
        ...
        private Boolean VerificarDadosInseridos()
        {
            ...
            if (var > 0)
            {
                MessageBox.Show("A data de registo tem de ser inferior ou igua à data de hoje!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            VerLocalizacaoDorEpisiotomia verLocalizacaoDorOnicocriptoses = new VerLocalizacaoDorEpisiotomia(paciente);
