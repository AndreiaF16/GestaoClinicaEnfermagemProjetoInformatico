    ...
    public partial class VerLocalizacaoDorEspirometria : Form
    {
        ...
        private void ver()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from LocalizacaoDorEspirometria WHERE IdPaciente = @IdPaciente ORDER BY data", conn);
        ...
        private void VerLocalizacaoDorEspirometria_Load(object sender, EventArgs e)
        {
            ver();
        }
