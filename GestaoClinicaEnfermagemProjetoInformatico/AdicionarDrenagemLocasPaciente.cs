...
namespace GestaoClinicaEnfermagemProjetoInformatico
{
    public partial class AdicionarDrenagemLocasPaciente : Form
    {
            ...
            if (id == -1)
            {
                ...
                if (resposta == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string queryInsertData = "INSERT INTO Atitude(nomeAtitude) VALUES('Drenagem locas');";
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (VerificarDadosInseridos())
            {
                ...
                catch (SqlException)
                {
                    ...
                    MessageBox.Show("Por erro interno é impossível registar a drenagem das locas!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        private Boolean VerificarDadosInseridos()
        {
            ...
            if (var > 0)
            {
                MessageBox.Show("A data de registi tem de ser inferior ou igual à data de hoje! \n Selecione outra data!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        MessageBox.Show("Não é possível registar a Drenagem das Locas, porque já está um registo na data que selecionou! \n Selecione outra data!", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        conn.Close();
                        return false;
                    }
